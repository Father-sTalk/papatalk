...
import SkeletonCardlistOnePopular from "@/components/skeleton/cardlist/skeleton_cardlist_one_popular";
import ListBasicSkeleton from "@/components/skeleton/list/skeleton_list_basic";
    ...
    <section className="flex flex-col gap-8 p-6">
      ...
      <div>
        ...
        {isLoading
          ? Array(10)
              .fill(null)
              .map((_, idx) => <ListBasicSkeleton key={idx} />)
